		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#WalkthroughApp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"WalkthroughApp-display": {
								"semanticObject": "WalkthroughApp",
								"action": "display",
								"description": "Aplicación Fiori",
								"title": "Walkthrough App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=walkthroughproject",
									"url": sap.ui.require.toUrl("walkthroughproject")
								}
							}
						}
					}
